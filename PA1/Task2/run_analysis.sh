...
#         -e cpu_core/l2_rqsts.swpf_miss/ \
#         -e sw_prefetch_access.t0,sw_prefetch_access.t1_t2,sw_prefetch_access.nta \
#         -e core_power.lvl1_turbo_license,core_power.lvl2_turbo_license \
#         ./emb $MODE 2>&1 | tee -a "$LOG_FILE"
...
# # # # Function to run performance analysis
# # # run_perf() {
# # #     echo "=== Running Performance Analysis for mode: $MODE ==="
# # #     taskset -c $CORE perf stat \
# # #         -e instructions,cycles,cache-misses,cache-references \
# # #         -e L1-dcache-loads,L1-dcache-load-misses \
# # #         -e LLC-loads,LLC-load-misses \
# # #         -e l2_rqsts.all_demand_miss,l2_rqsts.references \
# # #         -e l2_rqsts.swpf_hit,l2_rqsts.swpf_miss \
# # #         -e sw_prefetch_access.t0,sw_prefetch_access.t1_t2,sw_prefetch_access.nta \
# # #         ./emb $MODE
# # # }
...
# # # Main execution
# # echo "Starting analysis for mode: $MODE"
...
# # # Re-enable hardware prefetchers if they were disabled
# # enable_hw_prefetch
...
# # # Output file (append mode)
# # LOG_FILE="perf_${MODE}_pf${HW_STATUS}.log"
# # CSV_FILE="perf_${MODE}_pf${HW_STATUS}.csv"